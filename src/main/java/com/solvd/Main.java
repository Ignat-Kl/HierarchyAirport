...
//        System.out.println("AirportName: " + airport1.getAirportName() + ", Addres: " + airportAddress1.getStreet());
        ...
        AirportEmployee employee2 = new AirportEmployee("EMP002", "Jan","Koval",LocalDateTime.of(1997,11,10,9,12),"Security",450.6,"Janl@.com");
...
//        passenger1.displayInfo();
        ...
        // Вывод значений воздушных судов в терминале 1
